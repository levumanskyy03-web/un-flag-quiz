...
const ru: ThemeCopy = pack({
  ...
  musicWorld: 'Музыка',
  musicSubtitle: 'Инструменты, сочинения и композиторы. Портреты — Wikimedia Commons.',
  musicFamilyInstruments: 'Инструменты',
  musicFamilyWorks: 'Сочинения',
  musicFamilyPeople: 'Люди',
  musicEasyMixNote: 'Семейства инструментов и известные пьесы.',
  musicHardMixNote: 'Все режимы, кроме портретов.',
  instrumentToFamily: 'Инструмент → семейство',
  composerToWork: 'Композитор → произведение',
  workToComposer: 'Произведение → композитор',
  musicPhotoToName: 'Портрет → композитор',
...
const en: ThemeCopy = pack({
  ...
  musicWorld: 'Music',
  musicSubtitle: 'Instruments, works, and composers. Portraits from Wikimedia Commons.',
  musicFamilyInstruments: 'Instruments',
  musicFamilyWorks: 'Works',
  musicFamilyPeople: 'People',
  musicEasyMixNote: 'Instrument families and famous works.',
  musicHardMixNote: 'All modes except portraits.',
  instrumentToFamily: 'Instrument → family',
  composerToWork: 'Composer → work',
  workToComposer: 'Work → composer',
  musicPhotoToName: 'Portrait → composer',
...
export const THEME_MODE_COPY: Record<Lang, ThemeCopy> = {
  ...
  de: pack({
    ...
    nocToName: 'NOK → Land',
    instrumentToFamily: 'Instrument → Familie',
    composerToWork: 'Komponist → Werk',
    workToComposer: 'Werk → Komponist',
    musicPhotoToName: 'Porträt → Komponist',
  ...
  zh: pack({
    ...
    nocToName: 'NOC → 国家',
    instrumentToFamily: '乐器 → 类别',
    composerToWork: '作曲家 → 作品',
    workToComposer: '作品 → 作曲家',
    musicPhotoToName: '肖像 → 作曲家',
  ...
  es: pack({
    ...
    nocToName: 'COI → país',
    instrumentToFamily: 'Instrumento → familia',
  ...
  pt: pack({
    ...
    instrumentToFamily: 'Instrumento → família',
