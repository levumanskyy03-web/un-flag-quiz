...
export default function AboutPage() {
  return (
    <LegalShell title="О проекте">
      ...
      <p>
        У каждой страны есть открытый паспорт: каталог на <a href="/countries">/countries</a>, языки —{' '}
        <a href="/languages">/languages</a>, сегодняшняя страна — <a href="/today">/today</a>.
      </p>
